# ⚡ QUICK START - Copy/Paste Ready SQL

## Step 1: Run Migration (Copy This)

```sql
-- ============================================
-- COPY EVERYTHING BELOW AND PASTE IN SUPABASE
-- ============================================
...
## Step 2: Run Population (Copy This)
...
-- Fertilizers & Substrates Subcategories
INSERT INTO categories (name, description, icon, parent_id, helper_text) VALUES
...
-- Repairs & Services Subcategories
INSERT INTO categories (name, description, icon, parent_id, helper_text) VALUES
...
2. Paste above code
3. Click "Run"
4. Should see multiple "Inserted 1 rows" or similar
...
Your categories are now set up with:
- ✅ 8 main categories
- ✅ 40+ subcategories  
- ✅ Full hierarchy
- ✅ Helper text for all
