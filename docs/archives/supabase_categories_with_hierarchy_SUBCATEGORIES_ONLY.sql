-- ============================================
-- AgriBuyX Subcategories Only (Main Categories Already Exist)
-- ============================================
-- This file ONLY adds subcategories to existing main categories
-- Main categories: Seeds & Seedlings, Fertilizers & Substrates, Plant Protection, 
-- Irrigation, Livestock & Pets, Machinery & Tools, Repairs & Services, Other Products

-- ============================================
-- 1. SEEDS & SEEDLINGS SUBCATEGORIES
-- ============================================
...
-- ============================================
-- 2. FERTILIZERS & SUBSTRATES SUBCATEGORIES
-- ============================================
...
-- ============================================
-- 3. PLANT PROTECTION SUBCATEGORIES
-- ============================================
...
-- ============================================
-- 5. LIVESTOCK & PETS SUBCATEGORIES
-- ============================================
...
-- ============================================
-- 6. MACHINERY & TOOLS SUBCATEGORIES
-- ============================================
...
-- ============================================
-- 7. REPAIRS & SERVICES SUBCATEGORIES
-- ============================================
...
-- ============================================
-- 8. OTHER PRODUCTS SUBCATEGORIES
-- ============================================
...
-- Count subcategories (should be 40+)
-- SELECT COUNT(*) as subcategories FROM categories WHERE parent_id IS NOT NULL;

-- Count all categories total
-- SELECT COUNT(*) as total_categories FROM categories;

-- View hierarchy with all subcategories
-- SELECT 
--   CASE WHEN m.parent_id IS NULL THEN '📍 ' ELSE '  └─ ' END as level,
--   COALESCE(m.icon, s.icon) as icon,
--   COALESCE(m.name, s.name) as name
-- FROM categories m
-- LEFT JOIN categories s ON s.parent_id = m.id
-- WHERE m.parent_id IS NULL OR s.parent_id IS NOT NULL
-- ORDER BY m.name, s.name;

-- Get all categories under a specific main category
-- SELECT sub.icon, sub.name, sub.helper_text
