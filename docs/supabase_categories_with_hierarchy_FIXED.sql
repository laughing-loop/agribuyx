-- ============================================
-- AgriBuyX Categories with Hierarchy & Helper Text - SIMPLIFIED VERSION
-- ============================================
-- This version uses a step-by-step approach to avoid subquery issues
-- Run each section separately in Supabase SQL Editor

-- NOTE: Run supabase_hierarchy_migration.sql FIRST
-- Then run each section below (one at a time)

-- ============================================
-- 1. INSERT ALL MAIN CATEGORIES FIRST
-- ============================================
...
-- ============================================
-- 2. SEEDS & SEEDLINGS SUBCATEGORIES
-- ============================================
...
-- ============================================
-- 3. FERTILIZERS & SUBSTRATES SUBCATEGORIES
-- ============================================
...
-- ============================================
-- 4. PLANT PROTECTION SUBCATEGORIES
-- ============================================
...
-- ============================================
-- 6. LIVESTOCK & PETS SUBCATEGORIES
-- ============================================
...
-- ============================================
-- 7. MACHINERY & TOOLS SUBCATEGORIES
-- ============================================
...
-- ============================================
-- 8. REPAIRS & SERVICES SUBCATEGORIES
-- ============================================
...
-- ============================================
-- 9. OTHER PRODUCTS SUBCATEGORIES
-- ============================================
...
-- Get all subcategories under a specific main category
